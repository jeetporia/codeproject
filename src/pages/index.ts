...
import { RootInjectorPage } from '../pages/root-injector/root-injector';
import { RouterNavigateMethodPage } from '../pages/router-navigate-method/router-navigate-method';
...
export const PagesList = [
    ...
    { component: RootInjectorPage,          title: 'Root Injector'},
    { component: RouterNavigateMethodPage,  title: 'Router Navigate Method'},
...
export const Menu: MenuOptionModel[] = [
    {
        ...
        },
        {
            ...
            component: RootInjectorPage,
        },
        {
            displayName: 'Router Navigate Method',
            component : RouterNavigateMethodPage,
        },
        {
            displayName : 'Promises in Angular 2',
            component : PromisesAngular2Page,
        },
        {
            displayName : 'Obserable vs Promises',
            component : ObersablesVsPromisesPage,
        },  
        {
